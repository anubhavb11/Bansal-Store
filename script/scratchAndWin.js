(function () {
  ...
  const markup1 = ` <div class="prize">
    <img class="prize__img" src="img/scratch-win/coca-cola.jpg" alt="" srcset="" />
    <div class="prize__name">
      <h3>Coca Cola 700mL</h3>
    </div>
  </div> `;
  const markup2 = ` <div class="prize">
    <img class="prize__img" src="img/scratch-win/kinder-joy.jpg" alt="" srcset="" />
    <div class="prize__name">
      <h3>Kinder Joy</h3>
    </div>
  </div> `;
  ...
  // image.src = "cover.PNG";
  image.src = "img/scratch-win/scratchImg.PNG";
  ...
  brush.src = "img/scratch-win/brush.png";
